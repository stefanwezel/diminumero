...
Usage:
    uv run tools/analyze_stress_test.py <file> [<file2> ...] [--html [PATH]]

Examples:
    uv run tools/analyze_stress_test.py /home/stefan/Documents/stress_test_results/stress_test_*.json
    uv run tools/analyze_stress_test.py result.json --html
    uv run tools/analyze_stress_test.py result1.json result2.json --html /tmp/report.html
"""
...
<footer>Generated by tools/analyze_stress_test.py</footer>
