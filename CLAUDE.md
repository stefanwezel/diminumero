...
- `/<lang_code>/numbers` — Number-practice config screen (easy/advanced/hardcore + magnitude dial + share-link builder). Also accepts shareable preset params — see "Shareable drill presets" below.
